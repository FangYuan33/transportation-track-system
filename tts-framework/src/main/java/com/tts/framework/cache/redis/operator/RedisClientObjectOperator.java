 ...
 * @since 2021-01-21
 */
public interface RedisClientObjectOperator <T> {
        ...
        * @return
        */
       Boolean set(String namespace,String key,T value);
        ...
        * @return
        */
       Boolean set(String namespace,String key,T value,long timeToLive, TimeUnit timeUnit);
				 ...
				 * @return
				 */
				Boolean setWithDefaultTTL(String namespace,String key,T value);
        ...
        * @return
        */
      T getAndSet(String namespace,String key,T value);
        ...
        * @return
        */
        T getAndSet(String namespace,String key,T value,long timeToLive, TimeUnit timeUnit);
        ...
        * @param namespace
		 ...
		 * @return
		 */
		Boolean compareAndSet(String namespace,String key, T  expect, T update);
        ...
        * @return
        */
       Boolean setIfExists(String namespace,String key,T  value);
        ...
        * @return
        */
       Boolean setIfExists(String namespace,String key,T value,long timeToLive, TimeUnit timeUnit);
        ...
        * @param namespace
		 ...
		 * @return
		 */
		Boolean trySet(String namespace,String key,T value);
       ...
       Boolean trySet(String namespace,String key,T value,long timeToLive, TimeUnit timeUnit);
        ...
        * @return
        */
      T getAndDelete(String namespace,String key);
