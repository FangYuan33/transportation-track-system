 ...
 * @since 2021-01-21
 */
public interface RedisClientQueueOperator {
		 ...
		 */
		<E> E remove(String namespace,String key, E eType);
		 ...
		 */
		<E> E poll(String namespace,String key, E eType);
		 ...
		 * @throws NoSuchElementException if this queue is empty
		 */
		<E> E element(String namespace,String key, E eType);
		 ...
		 * @return the head of this queue, or {@code null} if this queue is empty
		 */
		<E> E peek(String namespace,String key, E eType);
